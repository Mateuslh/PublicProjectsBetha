...
def enviar(registros):
    ...
    try:
        ...
        for item in registros:
            ...
            dado = {
                'idIntegracao': encurtar(sistema, tipo_registro,'secretaria',item['anoletivo']),
                'conteudo': {
                    'anoLetivo': {
                        'id': item['anoletivo']
                    },
