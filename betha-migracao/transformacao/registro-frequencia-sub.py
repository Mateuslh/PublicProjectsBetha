...
endereco = f'https://educacao.betha.cloud/service-layer/v2/api/registro-frequencia'
    ...
    try:
        ...
        for item in registros:
            ...
            dado = {
                ...
                'conteudo': {
                    'quantidadeFaltas': item['quantidadefaltas'],
                    'anoLetivo': {
                        'id': item['anoletivo']
                    },
                    'estabelecimento': {
            ...
            if 'itemeducacionalaula' in item and item['itemeducacionalaula'] is not None:
                dado['conteudo'].update({
                    'itemEducacional': {
                        'id': item['itemeducacionalaula']
                    }
                })
            else:
                dado['conteudo'].update({
                    'itemEducacional': {
                        'id': item['itemeducacionaldia']
                    }
                })
