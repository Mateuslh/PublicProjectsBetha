...
endereco = f'https://educacao.betha.cloud/educacao/conversao/api/turmas'
            ...
            dado = {
                ...
                'turma': {
                    ...
                    'configuracaoHorasAulas': {
                        'id': item['configuracaohorasaulas']
                    },
                    'tipoMediacaoDidaticoPedagogica': item['tipomediacaodidaticopedagogica'],
                    'participaMaisEducacao': item['participamaiseducacao'],
                    'turno': item['turno'],
                    ...
                    'etapaEnsinoInep': {
                        'id': item['etapaensinoinep']
                    },
                    'calendarioMatrizCurricular': {
                        'id': item['calendariomatrizcurricular']
                    },
                    'quantidadeMaximaAlunos': item['quantidademaximaalunos'],
                    'quantidadeExamesFinais': item['quantidadeexamesfinais'],
                    'tipoRegistroFrequencia': item['tiporegistrofrequencia']
                }
            }

            # print(f'@ Dado(s) gerado(s) ({contador}): ', dado)
            lista_dado.append(dado)
            lista_controle.append(formatar([dado['turma']],item['id_desktop'])[0])
    except Exception as e:
